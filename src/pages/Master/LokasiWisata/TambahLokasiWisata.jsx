...
const TambahLokasiWisata = () => {
  ...
  const saveLokasiWisata = async (e) => {
    e.preventDefault();
    e.stopPropagation();
    ...
    if (form.checkValidity()) {
      ...
      try {
        setLoading(true);
        await axios.post(`${tempUrl}/saveLokasiWisata`, {
          namaLokasiWisata,
          linkGoogleMaps,
          latitude,
          longitude,
  ...
  return (
    <Container>
      <h3>Data Web</h3>
      <h5 style={{ fontWeight: 400 }}>Tambah Lokasi Wisata</h5>
      <hr />
      <Card>
        <Card.Header>Lokasi Wisata</Card.Header>
        <Card.Body>
          <Form noValidate validated={validated} onSubmit={saveLokasiWisata}>
            <Row>
              <Col sm={6}>
                <Form.Group
                  as={Row}
...
export default TambahLokasiWisata;
