...
const TambahLokasiPetinggi = () => {
  ...
  const saveLokasiPetinggi = async (e) => {
    e.preventDefault();
    e.stopPropagation();
    ...
    if (form.checkValidity()) {
      ...
      try {
        setLoading(true);
        await axios.post(`${tempUrl}/saveLokasiPetinggi`, {
          namaLokasiPetinggi,
          linkGoogleMaps,
          latitude,
          longitude,
  ...
  return (
    <Container>
      ...
      <Card>
        ...
        <Card.Body>
          <Form noValidate validated={validated} onSubmit={saveLokasiPetinggi}>
            <Row>
              <Col sm={6}>
                <Form.Group
                  as={Row}
...
export default TambahLokasiPetinggi;
